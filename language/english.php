...
$LANG_indexnow = array(
    ...
    'history_private_content' => 'Private content: anonymous read access is not available.',
    'history_private_plugin_content' => 'Private or unverifiable plugin content: anonymous URL access is required.',
    'history_url_rejected' => 'URL rejected: URL must use HTTP(S) and belong to the Geeklog site host.',
    'history_delete_not_submitted' => 'Deletion not submitted: no previous successful public submission exists.',
    'history_previous_url_rejected' => 'URL rejected: previous URL is no longer valid for this Geeklog host.',
    'history_no_key' => 'No IndexNow key configured.',
    'history_invalid_key' => 'Invalid IndexNow key configured.',
    'history_url_accepted' => 'IndexNow accepted the URL.',
    'history_request_failed' => 'IndexNow request failed.',
    'history_batch_accepted' => 'IndexNow accepted the batch.',
    'history_batch_failed' => 'IndexNow batch request failed.',
    ...
    'cleanup_audit_record' => 'Audited %d previously successful URL(s); queued %d remediation URL(s).',
    'cleanup_audit_legacy_append' => ' Pre-1.2.0 submissions cannot be reconstructed safely because no submission history existed.',
    'cleanup_legacy_record' => 'Pre-1.2.0 submission history is unavailable. No private URL was sent during remediation because prior disclosure cannot be proven safely.',
    'cleanup_result_missing' => 'Cleanup submission result was not recorded.',
