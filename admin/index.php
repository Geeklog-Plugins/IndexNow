...
.ixn-history-wrap{margin-top:18px}.ixn-help{margin-top:18px;padding:15px 18px;border:1px solid #dfe3e8;border-radius:8px;background:#fafbfc}.ixn-help summary{display:flex;align-items:center;gap:8px;cursor:pointer;font-weight:600;list-style:none}.ixn-help summary::-webkit-details-marker{display:none}.ixn-help summary:before{content:"";display:inline-block;flex:0 0 auto;width:0;height:0;border-top:5px solid transparent;border-bottom:5px solid transparent;border-left:7px solid currentColor;transition:transform .15s ease;transform-origin:40% 50%}.ixn-help[open] summary:before{transform:rotate(90deg)}
